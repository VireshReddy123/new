...
public class RatePlanPage extends BasePage {
    ...
    public void createPlan(String groupSelect, String usagetype, String nameText, String descriptionText, String rollupText, String chargeTypeText, int allocationText, String ratingMethodText, int unitText, String rateText) throws InterruptedException {
